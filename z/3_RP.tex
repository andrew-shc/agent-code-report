...
cactus). ReSIR: fwd=16~spp, cand=8, bwd=1~spp, biased, 500~iters.
Standard baseline from \texttt{ASSETS/standard\_NPBIR\_reeval}; ReSIR
from \texttt{ASSETS/pipeline/restir\_NPBIR\_v1}.
